...
@section('content')
    <section id="suppliers">
        <div class="container-fluid">
            <h2 class="text-center">Piegādātāji</h2>
            <div class="mt-2 mb-5 mr-2 text-right">
                <button type="button" class="btn btn-primary add-button">Pievienot</button>
            </div>
            <table id="suppliers-table" class="table table-striped table-bordered table-responsive table-hover bg-white">
            ...
            @include('includes.modals.suppliers.create')
            @include('includes.modals.suppliers.edit')
